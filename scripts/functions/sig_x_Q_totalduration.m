function [x_Q_totalduration, error_flag, error_str] = sig_x_Q_totalduration(Q, t, type, varargin)
...
switch type
    ...
    case 'no'
        ...
        x_Q_totalduration = x_Q_num/length(wateryears);
    ...
    case 'custom_high'
        ...
        x_Q_totalduration = NaN(length(threshold),1);
        for t = 1:length(threshold)
            x_Q_num = length(Q(Q>threshold(t)));
            x_Q_totalduration(t) = x_Q_num/length(wateryears);
        end
